...
def get_data(url):
    ...
    update_time = soup.select_one("div.adPage__aside__stats__date")

    # Select only four specific characteristics
    characteristics = {}
    for key in ['Suprafață totală', 'Starea apartamentului', 'Numărul de camere', 'Nivelul']:
    ...
    data = {
        ...
        "update_time": update_time.text.strip() if update_time else "None",
